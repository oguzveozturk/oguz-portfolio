...
imageFolder: "flights"
imageCount: 3
paragraph: "The user can drag the map to view active flights from the OpenSky API. Tapping an aircraft shows its ICAO24 code and origin country, and flights can be filtered by origin country using the list at the bottom of the screen."
---
...
• <strong>FlightAPI</strong>: Handles communication with the OpenSky API — building requests, parsing responses and handling errors.<br>
